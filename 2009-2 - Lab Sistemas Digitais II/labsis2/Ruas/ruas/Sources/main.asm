...
AUXBUFFER: DS 1 ;auxiliar para conferir qual buffer que e'
...
;@@@@@@@@@@@@@@@@@@@@@@ configuracao do microcontrolador @@@@@@@@@@@@@@@@@@@@@@@@@@@@@
            ...
            MOV #$42,OSCSC ;oscilador externo da central e clock enable no bit 1
            MOV #$00,KBSCR ;interrupçoes de borda e habilitados
            MOV #$03,KBIER ;as portas PTA 1 e 0 sao interrupçoes
            MOV #$03,KBIPR ;as interrupçoes sao de borda de descida
*            MOV #$20,TSC ;parado e com 0 de divisor                               
                        
clock:      
            BRSET 0,OSCSC,controlck
            BRA clock      
...
;            ;confere qual buffer que tem que ser usado
;            MOV #$0,AUXBUFFER ;zera o AUXBUFFER
;confere:    LDHX BUFFER
;            AIX #AUXBUFFER
;            CPHX #0
;            BEQ medevel            
