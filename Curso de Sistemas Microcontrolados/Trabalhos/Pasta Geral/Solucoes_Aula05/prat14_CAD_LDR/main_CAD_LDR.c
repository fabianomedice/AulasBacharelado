 ...
 * Autor:				SEMPRA
 * Versão:				v1.0
 * Descrição:	Prática 14: Conversor AD e transdutor LDR
 *		Utilizar o display de LCD para mostrar o valor da tensão medida no
 *	pino RE0/AN5, onde está conectado o LDR.
...
void main(void)
{
	...
	EscreveFraseRomLCD("CAD com LDR");

	// Inicia a primeira medida
	SelChanConvADC(ADC_CH5);
