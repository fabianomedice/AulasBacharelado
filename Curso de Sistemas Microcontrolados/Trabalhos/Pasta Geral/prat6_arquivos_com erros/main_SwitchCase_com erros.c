 ...
 * Autor:				SEMPRA
 * Versão:				v1.0
 * Descrição:	Prática 4: Switch-Case
 *	Acionar três dispositivos distintos de acordo com as combinações dos
 * dois Botões.
 *	BT2	BT1
 *	0	0	= Todos os dispositivos desligados
 *	0	1	= Liga somente LED_VERMELHO
 *	1	0	= Liga somente LED_AMARELO
 *	1	1	= Liga somente RELÉ
 *****************************************************************************/
...
#define	LED_VERMELHO	LATCbits.LATD1
