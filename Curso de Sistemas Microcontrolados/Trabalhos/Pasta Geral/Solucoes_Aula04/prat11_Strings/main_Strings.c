 ...
 *
 ******************************************************************************
 * Nome do Arquivo:		main_Strings.c
 ...
 * Autor:				SEMPRA
 * Versão:				v1.0
 * Descrição:	Prática 11: Manipulaçãode Strings
 *		Criar 3 strings (vetores do tipo char) de 17 posições. 
 *	- String 1: Mem. de Dados (SRAM), inicializada com a palavra “Curso ”.
 *	- String 2 – Mem. de Programa (FLASH),inicializada com a palavra “SEMPRA”
 *	- String 3 – Mem. de Dados (SRAM) sem inicializar.
 *		Usar funções das bibliotecas string.h:
 *	- Utilize o strcatpgm2ram( ) para unir as strings 1 e 2 resultando “Curso SEMPRA”.
 *	- Utilize o strcpy( ) para copiar a string resultante na string 3.
 *****************************************************************************/
...
void main(void)
{
	// Declaração de 3 strings, nas memórias SRAM e FLASH
	char string1[17] = "Curso";
	static rom char string2[17] = " Sempra";
	char string3[17];
	...
	// Concatena string2 no fim da string1, sendo que string2 está armazenada
	//na memória FLASH e string1 na memória SRAM.
	strcatpgm2ram(string1, string2);
	
	// Copia conteudo da string1 para string3, sendo que ambas estão armazenadas
	//na memória SRAM.
