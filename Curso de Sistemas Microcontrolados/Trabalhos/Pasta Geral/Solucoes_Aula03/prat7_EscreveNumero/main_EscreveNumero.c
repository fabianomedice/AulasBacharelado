 ...
 *
 ******************************************************************************
 * Nome do Arquivo:		main_ContPecas.c
 ...
 * Autor:				SEMPRA
 * Versão:				v1.0
 * Descrição:	Prática 7: Escreve Numero Display 7 Segmentos
 *		Escrever 00 ou 01 no display de 7 segmentos de acordo com o estado da
 * chave  CH1 (RA1)
 *		Utilize as funções disponíveis na biblioteca da SEMPRA ?display7seg.h?
 *****************************************************************************/
...
void main(void)
{
	...
	while(1)
	{
		// Testa posição da chave1
		if(CH1)
		{
			//Escreve o valor um no display de 7 segmentos
 			EscreveDisplay7seg(1, PONTO_NENHUM);
		}
		else
		{
			//Escreve o valor zero no display de 7 segmentos
			EscreveDisplay7seg(0, PONTO_NENHUM);
		}
	}//end while(1)
