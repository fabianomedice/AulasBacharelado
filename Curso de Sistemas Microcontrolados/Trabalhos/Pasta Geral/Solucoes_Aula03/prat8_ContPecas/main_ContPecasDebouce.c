 ...
 * Autor:				SEMPRA
 * Versão:				v1.0
 * Descrição:	Prática 8: Contador de Peças
...
void main(void)
{
	char cont = 0;		// Armazena o valor da contagem das peças
	...
	while(1)
	{
		...
		if(BOTAO1)
		{
            ...
            // Espera soltar botão
			while(BOTAO1)	{ /*não faz nada no while, só gasta tempo até solta botão */ }
