 ...
 *
 ******************************************************************************
 * Nome do Arquivo:		main_Cronometro.c
 ...
 * Autor:				SEMPRA
 * Versão:				v1.0
 * Descrição:	Prática 10: Cronometro
 * - Criar uma cronômetro digital que conte de 00 à 99 segundos
 * - Usar biblioteca delays.h, do compilador C18, para gerar a espera ocupada de 1 segundo
 * - Usar a biblioteca display7seg.h, da SEMPRA, para mostrar a contagem de
 * tempo do cronometro no display de 7 segmentos.
 *	
 *****************************************************************************/
...
void main(void)
{
	...
	while(1)
	{
		...
		//Laço de repetição que escreve no display de 7 segmentos numeors de 0 à 99
		for(cont = 0; cont<100; cont++)
		{
			//Escreve o valor de contador no display de 7 segmentos		
			EscreveDisplay7seg(cont, PONTO_NENHUM);
	
			// Atraso de 1 segundo = 5*200ms
