 ...
 *
 ******************************************************************************
 * Nome do Arquivo:		main_PiscaLed.c
 ...
 * Autor:				SEMPRA
 * Versão:				v1.0
 * Descrição:	Prática 9: Pisca LED
 *	- Fazer o LED_VERDE piscar a cada 200ms.
 *	- Usar uma função da biblioteca delays.h, do compilador C18, para fazer a
 *	CPU do PIC18F4550 gastar o tempo de 200ms.
 *	
 *****************************************************************************/
...
#include <delays.h>		//Bilioteca com funções de delays do compilador C18
...
void main(void)
{
	...
	while(1)
	{
		LED_VERDE = !LED_VERDE;	//Alterna estado do LED_VERDE
