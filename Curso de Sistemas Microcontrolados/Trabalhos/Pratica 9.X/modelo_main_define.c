...
#include <delays.h>                             // Necessário para que o compilador adicione a biblioteca
						// com as definições e funções de delay

#include "display7seg.h"                        // Necessário para que o compilador adicione a biblioteca
                                                // com as definições e funções do display de 7 segmentos
