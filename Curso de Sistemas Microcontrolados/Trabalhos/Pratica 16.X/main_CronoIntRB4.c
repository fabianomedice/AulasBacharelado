 ...
 *
 ******************************************************************************
 * Nome do Arquivo:		main_CronoIntRB4.c
 ...
 * Autor:				SEMPRA
 * Versão:				v1.0
 * Descrição:	Prática 16: Interrupção Externa RB4
 *		Usar uma função de tratamento de interrupção de Baixa Prioridade,
 *	para tratar o evento de mudança de estado no pino RB4.  Dentro da função
 *	de tratamento da interrupção acionar o BUZZER para tocar 2 bip's curtos
 *	e alternar o estado do LED_AMARELO.
 *****************************************************************************/
