...
tamanho_x = tamanho(1)*porcentagem/100;  %tem q transformar em numeros inteiros
tamanho_y = tamanho(2)*porcentagem/100;  %tem q transformar em numeros inteiros
img3=img1;
...
a=0;
while a~=(tamanho(1)*(100-porcentagem)/100+1)
    b=0;
    while  b~=(tamanho(2)*(100-porcentagem)/100+1)
        i=1;                
        z=1;
